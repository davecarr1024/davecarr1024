...
- A phase is not done until the presubmit command, coverage gate, documentation updates, fresh-context self review, Gemini CLI review request when available, commit, and push all succeed.
